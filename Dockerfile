...
RUN wget --no-check-certificate -c https://github.com/phpmyadmin/phpmyadmin/archive/RELEASE_4_6_0.tar.gz; \
        tar zxvf RELEASE_4_6_0.tar.gz;\
        mv phpmyadmin-RELEASE_4_6_0 /www; \
        unlink *.tar.gz
