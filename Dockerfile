...
RUN wget --no-check-certificate -c https://github.com/phpmyadmin/phpmyadmin/archive/RELEASE_4_5_3_1.tar.gz; \
        tar zxvf RELEASE_4_5_3_1.tar.gz;\
        mv phpmyadmin-RELEASE_4_5_3_1 /www; \
        unlink *.tar.gz
